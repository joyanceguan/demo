...
import com.joyance.demo.utils.InputUtil;
...
public class NIOClient {
	...
	public static void main(String[] args) {
		try {
			EchoClientHandle handle = new NIOClient().new EchoClientHandle();
		} catch (Exception e) {
	...
	class EchoClientHandle implements AutoCloseable {
	    ...
	    public EchoClientHandle() throws Exception {
	        ...
	        this.clientChannel.connect(new InetSocketAddress("localhost",8081)) ;
	        this.accessServer();
	    }
